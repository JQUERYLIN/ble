...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "com.gr_ble.bluetooth.le.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.gr_ble.bluetooth.le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.gr_ble.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE = "com.gr_ble.bluetooth.le.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA = "com.gr_ble.bluetooth.le.EXTRA_DATA";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback()
    {
                                            ...
                                            int newState)
        {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED)//连接成功
            {
                ...
                /* 通过广播更新连接状态 */
                EventBus.getDefault().post(new GattReceiverEvent(ACTION_GATT_CONNECTED));
            ...
            } else if (newState == BluetoothProfile.STATE_DISCONNECTED)//连接失败
            {
                ...
                EventBus.getDefault().post(new GattReceiverEvent(ACTION_GATT_DISCONNECTED));
                // broadcastUpdate(intentAction);
            }
        }
        /*
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status)
        {
            ...
            {
                EventBus.getDefault().post(new GattReceiverEvent(ACTION_GATT_SERVICES_DISCOVERED));
    ...
    private void broadcastUpdate(final String action, int rssi)
    {
        ...
        //EventBus.getDefault().post(new GattReceiverEvent(new String(data)));
                                ...
                                final BluetoothGattCharacteristic characteristic)
    {
        ...
        String revData= ByteUtils.byte2String(data).toLowerCase();
        if (data != null && data.length > 0)
        {
            ...
            EventBus.getDefault().post(new DataEvent(revData));
                    ...
                    for (int i = 0;i<mList.size();) {
                        try {
                            if (mSendState) {
                                ...
                                mWaitCount++;
                                Log.d("AppRun"+getClass().getSimpleName(),String.valueOf(mList.size()));
                                Log.d("AppRun"+getClass().getSimpleName(),String.valueOf(i));
                                Log.d("AppRun"+getClass().getSimpleName(),String.valueOf(mSendState));
                                Log.d("AppRun"+getClass().getSimpleName(),"等待中..");
                                Log.d("AppRun"+getClass().getSimpleName(),String.valueOf(mWaitCount));
                                Thread.sleep(20);
                                if(mWaitCount>20) {
                                    mSendState = true;
                                    mWaitCount=0;
